...
describe('Desmarcar como "me gusta" tests', () => {
    test('el usuario desmarca como “me gusta” una publicación que tiene un “me gusta”', async () => {
        publicationService.checkLike.mockResolvedValueOnce({ success: true });
        ...
        const likeButton = screen.getByTestId('FavoriteIcon');
        await act(async () => {
    ...
    test('el usuario desmarca como “me gusta” una publicación que tiene “me gustas”', async () => {
        publicationService.checkLike.mockResolvedValueOnce({ success: true });
        publicationService.countLikes.mockResolvedValueOnce({ count: 2 });
        publicationService.getCommentsOfPublication.mockResolvedValueOnce({ comments: [] });
        publicationService.addLike.mockResolvedValueOnce({
            id: "id1",
            country: "México",
        ...
        const postView = {
            ...
            user: "testUsername123",
            dateTripFinish: new Date(),
            likes: ['testUsername2', 'testUsername'],
            images: []
        }
        const userSession = {
            username: 'testUsername',
