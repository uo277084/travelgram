...
describe('Descartar tests', () => {
    test('el usuario descarta la publicación que tiene guardada', async () => {
        ...
        const likeButton = screen.getByTestId('BookmarkIcon');
        await act(async () => {
            fireEvent.click(likeButton);
        });

        expect(screen.queryByTestId('BookmarkIcon')).toBeNull();
